...
const CourseDetail = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-gray-900">
            ...
            <section className="py-24 px-6 text-center text-white relative overflow-hidden" style={{ background: course.theme.gradient || course.theme.primary }}>
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        <Link to="/contact" className="px-12 py-5 bg-white rounded-full font-black text-xl shadow-2xl hover:bg-gray-100 hover:scale-105 transition-all" style={{ color: course.theme.primary }}>
                            Enroll Now →
                        </Link>
                        <button className="px-12 py-5 border-2 border-white text-white rounded-full font-black text-xl hover:bg-white/10 transition-all">
                            Download Syllabus
                        </button>
                    </div>
                </div>
