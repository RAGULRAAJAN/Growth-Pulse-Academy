    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-hero-gradient">
            ...
            <div className="container mx-auto px-6 md:px-12 lg:px-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="relative z-10 flex justify-center lg:justify-end mt-24 md:mt-32 lg:mt-0">
                    <div className="relative w-full max-w-[350px] md:max-w-[500px] lg:max-w-[600px] aspect-square">
                        ...
                        <img src={robotHero} alt="AI Robot" className="relative w-full h-full object-contain drop-shadow-2xl scale-[1.5] md:scale-[1.8] xl:scale-[2.2]" />
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-20">
                <svg className="relative block w-full h-[80px] md:h-[120px] lg:h-[150px] rotate-180" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
